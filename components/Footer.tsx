...
const Footer = () => {
    ...
    return (
        <footer className="bg-white dark:bg-[#040D06] border-t border-gray-200 dark:border-white/5 py-12 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
                    ...
                    <div className="text-center md:text-left">
                        <h3 className="text-2xl font-bold text-[#040D06] dark:text-[#E0EADD] mb-2 font-sans">
                            Panha<span className="text-[#00bfa5] dark:text-[#00FF94]">.dev</span>
                        </h3>
                    ...
                    <div className="flex flex-col items-center md:items-end gap-4">
                        <div className="flex items-center gap-4">
                            <SocialLink href="https://github.com/Sopanha9" icon={<Github className="w-5 h-5" />} label="GitHub" />
                            <SocialLink href="#" icon={<Linkedin className="w-5 h-5" />} label="LinkedIn" />
                            <SocialLink href="#" icon={<Send className="w-5 h-5" />} label="Telegram" />
                        </div>
                ...
                {/* Bottom Bar */}
                <div className="border-t border-gray-300 dark:border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500 dark:text-gray-500 font-sans">
