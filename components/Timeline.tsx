...
const timelineData: TimelineItem[] = [
    ...
    },
    {
        ...
        description:
            "Enrolled in short course at Uddompang learning platform.",
        icon: BookOpen,
    },
    {
        year: "2024",
    ...
    },
    {
        ...
        description:
            "Built lots of academic projects and lead my own team.",
        icon: Quote,
    },
    {
        year: "2026 (Present)",
    ...
    return (
        <div className="w-full relative mt-24 md:mt-32">
            <div className="max-w-4xl mx-auto relative">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold font-sans dark:text-white text-gray-900 mb-4">
                        Life Long <span className="text-neo-mint drop-shadow-[0_0_10px_rgba(0,255,148,0.5)]">Learning Journey</span>
                    </h2>
                    <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        My path from entering the world of code to becoming a software architect.
                    </p>
                </motion.div>
...
const TimelineItemCard = ({ item, index }: { item: TimelineItem; index: number }) => {
    ...
    return (
        ...
        >
            ...
            {/* Content Side */}
            <div className={`w-full md:w-1/2 ${isEven ? "md:pl-16 pl-12" : "md:pr-16 pl-12"}`}>
                <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-6 rounded-2xl hover:border-neo-mint/30 transition-colors duration-300 relative group backdrop-blur-sm">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 font-sans group-hover:text-neo-mint transition-colors">
                        {item.title}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-khmer">
                        {item.description}
                    </p>
                </div>
            </div>
